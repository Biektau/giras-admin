...
import styles from "./WorkWearUpdateForm.module.scss";
import axios from "axios";
import { useNavigate } from "react-router-dom";

export default function WorkWearUpdateForm({ item }) {
  ...
  const handleSubmit = async (event) => {
    ...
    if (
      ...
      try {
        ...
        await axios
          .put(`https://giras-backend-ruzal-02.amvera.io/workWear/update/${item._id}`, {
            name: values.name,
            price: values.price,
            color: values.color,
      ...
      >
        ...
        <div className={styles.inputLine}>
          ...
          <input
            ...
            onChange={(e) => handleChange(e)}
            autoComplete="off"
            placeholder={item.protectionClass}
          />
        </div>
        <div className={styles.inputLine}>
