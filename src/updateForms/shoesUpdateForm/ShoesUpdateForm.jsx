...
import styles from "./ShoesUpdateForm.module.scss";
import axios from "axios";
import { useNavigate } from "react-router-dom";

export default function ShoesUpdateForm({ item }) {
  ...
  const [values, setValues] = useState({
    ...
    insole: item.insole,
    sole: item.sole,
    fasteningMethod: item.fasteningMethod,
    sizes: item.sizes,
    ...
    >
      ...
      <div className={styles.inputLine}>
        ...
        <input
          ...
          onChange={(e) => handleChange(e)}
          autoComplete="off"
          placeholder={item.fasteningMethod}
        />
      </div>
